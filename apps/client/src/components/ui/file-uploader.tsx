      ...
      >
        {({ getRootProps, getInputProps, isDragActive }) => (
          <div
            {...getRootProps()}
            className={cn(
              "group p-3 h-full relative grid w-full cursor-pointer place-items-center rounded-lg border-2 border-dashed border-muted-foreground/25 px-5 py-2.5 text-center transition hover:bg-muted/25",
          ...
          >
            ...
            {isDragActive ? (
              ...
              <div>
                <div className="rounded-full border  p-2 border-dashed">
                  <UploadIcon className="size-7 text-muted-foreground" aria-hidden="true" />
                </div>
              </div>
            )}
